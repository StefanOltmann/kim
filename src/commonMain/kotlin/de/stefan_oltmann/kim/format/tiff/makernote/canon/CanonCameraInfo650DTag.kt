...
/**
 * Tags of the CameraInfo650D maker note sub-directory.
 *
 * See https://exiftool.sourceforge.net/TagNames/Canon.html#CameraInfo650D
 */
@Suppress("MagicNumber", "StringLiteralDuplication", "MaxLineLength")
public object CanonCameraInfo650DTag {
    ...
    public val FILE_INDEX_2: TagInfoLong = TagInfoLong(
        0x274, "FileIndex",
        TiffDirectoryType.EXIF_DIRECTORY_MAKER_NOTE_CANON_CAMERA_INFO
    )
    ...
    public val DIRECTORY_INDEX_2: TagInfoLong = TagInfoLong(
