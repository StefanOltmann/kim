...
/**
 * Tags of the CameraInfo1DmkII maker note sub-directory.
 *
 * See https://exiftool.sourceforge.net/TagNames/Canon.html#CameraInfo1DmkII
 */
@Suppress("MagicNumber", "StringLiteralDuplication", "MaxLineLength")
public object CanonCameraInfo1DmkIITag {
    ...
    public val FOCAL_TYPE: TagInfoByte = TagInfoByte(
        0x2d, "FocalType",
        TiffDirectoryType.EXIF_DIRECTORY_MAKER_NOTE_CANON_CAMERA_INFO
    )
    ...
    public val CANON_IMAGE_SIZE: TagInfoShort = TagInfoShort(
        0x39, "CanonImageSize",
        TiffDirectoryType.EXIF_DIRECTORY_MAKER_NOTE_CANON_CAMERA_INFO
    )

    public val JPEG_QUALITY: TagInfoByte = TagInfoByte(
        0x66, "JPEGQuality",
        TiffDirectoryType.EXIF_DIRECTORY_MAKER_NOTE_CANON_CAMERA_INFO
    )
