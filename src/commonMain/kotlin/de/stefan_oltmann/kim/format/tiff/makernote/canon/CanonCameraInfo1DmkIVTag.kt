...
/**
 * Tags of the CameraInfo1DmkIV maker note sub-directory.
 *
 * See https://exiftool.sourceforge.net/TagNames/Canon.html#CameraInfo1DmkIV
 */
@Suppress("MagicNumber", "StringLiteralDuplication", "MaxLineLength")
public object CanonCameraInfo1DmkIVTag {
    ...
    public val MEASURED_EV3: TagInfoByte = TagInfoByte(
        0x9, "MeasuredEV3",
        TiffDirectoryType.EXIF_DIRECTORY_MAKER_NOTE_CANON_CAMERA_INFO
    )
