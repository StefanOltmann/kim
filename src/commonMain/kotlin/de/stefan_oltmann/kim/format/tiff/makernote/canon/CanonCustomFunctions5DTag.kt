...
/**
 * Tags of the Functions5D maker note sub-directory.
 *
 * See https://exiftool.sourceforge.net/TagNames/Canon.html#Functions5D
 */
@Suppress("MagicNumber", "StringLiteralDuplication", "MaxLineLength")
public object CanonCustomFunctions5DTag {
    ...
    public val LCD_DISPLAY_RETURN_TO_SHOOT: TagInfoByte = TagInfoByte(
        0x12, "LCDDisplayReturnToShoot",
        TiffDirectoryType.EXIF_DIRECTORY_MAKER_NOTE_CANON_CUSTOM_FUNCTIONS
    )
