...
/**
 * Tags of the CameraInfoUnknown maker note sub-directory.
 *
 * See https://exiftool.sourceforge.net/TagNames/Canon.html#CameraInfoUnknown
 */
@Suppress("MagicNumber", "StringLiteralDuplication", "MaxLineLength")
public object CanonCameraInfoUnknownTag {

    public val LENS_SERIAL_NUMBER: TagInfoUndefineds = TagInfoUndefineds(
        0x16b, "LensSerialNumber", 5,
