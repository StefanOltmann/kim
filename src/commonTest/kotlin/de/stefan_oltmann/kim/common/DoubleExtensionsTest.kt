...
class DoubleExtensionsTest {
    ...
    fun testFloatsUseShortestFloatDigits() {
        ...
        /*
         * JDK 17's Float.toString emits "1.04036508E11" for these bits;
         * JDK 21+ and this function use the shorter unique spelling.
         */
        assertEquals(
            "1.0403651E11",
            Float.fromBits(JAVA17_EXTRA_DIGIT_FLOAT_BITS).toInvariantString()
        )
    }
